 ...
 *
 * The $settings['custom_error_message'] allows you to override the default
 * error message generated on fatal errors.
 */
# $settings['custom_error_message'] = 'The website encountered an unexpected error. Please try again later.';
