...
class FinalExceptionSubscriberTest extends UnitTestCase {
  ...
  /**
   * Test custom error message for drupal core.
   */
  public function testOnExceptionWithCustomCoreErrorMessage() {
    // Configure custom error message for the site
    $settings = new Settings(['custom_error_message' => 'This is custom error message for the site.']);
    ...
    // of this so we'll hard code it here.
    $request->setRequestFormat('bananas');
    $e = new MethodNotAllowedHttpException(['POST', 'PUT']);
